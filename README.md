...
```
  1. Install Go
  2. git clone https://github.com/fengdangxing/fdx-kingshard.git $GOPATH/src/github.com/fengdangxing/fdx-kingshard
  3. cd $GOPATH/src/github.com/fengdangxing/fdx-kingshard
  4. source ./dev.sh
  5. make
